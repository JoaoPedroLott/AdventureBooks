...
<head>
    <title>Adventure Books | Produtos</title>
...
<div class="wrapper">
  <!--=== Header v5 ===-->   
    ...
    <div class="breadcrumbs-v4">
        <div class="container">
            <span class="page-name">Livros</span>
            <h1>Produtos<span class="shop-green"> Adventure</span> Books</h1>
	...
	<br><br><br>		
				...
				<div class="col-md-12">
                 <%
					...
					for (Livro lv : livros) {
						out.write("<div class="+"illustration-v2"+">");
							out.write("<div class="+"col-md-4"+">");
								out.write("<div class="+"product-img product-img-brd"+">");
									...
									out.write("<button class="+"btn"+" "+"btn-primary"+" "+"href="+"#"+">Adicionar ao Carrinho</a>");
								out.write("</div>");
								out.write("<div class="+"product-description product-description-brd"+">");
									out.write("<div class="+"overflow-h margin-bottom-5" + ">");
										out.write("<div class=" + "pull-left" + ">");
											out.write("<h4 class=" + "title-price" + "><a href=" + "shop-ui-inner.jsp" + ">" + lv.getTitulo()+"</a></h4>");
											out.write("<span class=" + "gender text-uppercase" + ">" + lv.getAssunto()+"</span>");
											out.write("<div class=" + "product-price"+ ">");
											out.write("<span class=" + "title-price" + ">R$ "+lv.getPreco()+"0</span>");
											out.write("</div>");
										out.write("</div>");
									out.write("</div>");
								out.write("</div>");								
