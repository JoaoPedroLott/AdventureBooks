...
<!--[if !IE]><!--> 
<%@page import="geral.LivroDAO"%>
<%@page import="beans.Livro"%>
<%@page import="java.util.ArrayList"%>
<html lang="en"> <!--<![endif]-->  
<head>
    <title>Adventure Books - Seu lugar é aqui!</title>
...
<div class="wrapper">
				...
				<div class="col-md-4">
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a href="shop-ui-filter-grid.jsp">Produtos</a></li>
                            </ul>
                        </li>
                        <!--Books-->
						 <!--about -->
            ...
            <ul>
                ...
                <li class="revolution-mch-1" data-transition="fade" data-slotamount="5" data-masterspeed="1000" data-title="Slide 3">
                    ...
                    <img src="assets/img/3.jpg"  alt="darkblurbg"  data-bgfit="cover" data-bgposition="right top" data-bgrepeat="no-repeat">
					 ...
					 <div class="tp-caption revolution-ch3 sft start"
                        ...
                        data-speed="1000"
                        data-start="500"
                        data-easing="Slide.easeInOut"
                        data-endeasing="Power1.easeIn"                        
                        data-endspeed="300">
                        <img src="assets/img/bart.png">
                    </div>
					...
					<div class="tp-caption revolution-ch3 sft start"
                        ...
                        data-endeasing="Power1.easeIn"                        
                        data-endspeed="300">
                        <strong>HQ's</strong> Marvel & DC Comics
                    </div>
                    ...
                    <div class="tp-caption revolution-ch4 sft"
                        ...
                        style="z-index: 6">
                        As melhores aventuras de seus<br>
                        Super Heróis favoritos estão aqui!
                    </div>
                ...
                <li class="revolution-mch-1" data-transition="fade" data-slotamount="5" data-masterspeed="1000" data-title="Slide 1">
                    ...
                    <div class="tp-caption revolution-ch1 sft start"
                        ...
                        data-endspeed="300">
                        GET OVER HERE! <br>
                        <strong>Os melhores livros de RPG</strong><br>
                        estão aqui.
                    </div>
                ...
                <li class="revolution-mch-1" data-transition="fade" data-slotamount="5" data-masterspeed="1000" data-title="Slide 5">
                    ...
                    <div class="tp-caption revolution-ch4 sft"
                        ...
                        data-captionhidden="off"
                        style="z-index: 6">
                        <strong>Princesas e Castelos</strong><br>
                        E muita fantasia para seus filhos.
                    </div>
                ...
                <li class="revolution-mch-1" data-transition="fade" data-slotamount="5" data-masterspeed="1000" data-title="Slide 2">
                    ...
                    <div class="tp-caption revolution-ch3 sft start"
                        ...
                        data-endeasing="Power1.easeIn"                        
                        data-endspeed="300">
                        Lançamentos de <strong>Scy-fi Books</strong><br> todas as semanas
                    </div>
					<br><br>
                    <!-- LAYER -->
                    <div class="tp-caption revolution-ch4 sft"
        ...
        <div class="illustration-v2 margin-bottom-60">
            <ul class="list-inline owl-slider">
				<%
					...
					livros = LivroDAO.getData();
					for (Livro lv : livros) {
						out.write("<li class="+ "item" +">");
						out.write("<div class="+ "product-img" +">");
						out.write("<a href="+"shop-ui-inner.jsp"+"><img class="+"full-width img-responsive"+" "+"src="+"assets/img/blog/09.jpg"+" "+ "alt="+"></a>");
						out.write("<a class="+"product-review"+" "+"href="+"shop-ui-inner.jsp"+">Resumo</a>");
						out.write("<a class="+"add-to-cart"+" "+"href="+"#"+">Comprar</a>");
						out.write("</div>");
						out.write("<div class="+"product-description product-description-brd"+">");
						out.write("<div class="+"overflow-h margin-bottom-5" + ">");
						out.write("<div class=" + "pull-left" + ">");
						out.write("<h4 class=" + "title-price" + "><a href=" + "shop-ui-inner.jsp" + ">" + lv.getTitulo()
								+ "</a></h4>");
						out.write("<span class=" + "gender text-uppercase" + ">" + lv.getAssunto() + "</span><br>");
						out.write("</div>");
						out.write(" <div class=" + "product-price" + ">");
						out.write("<span class=" + "title-price" + ">" + lv.getPreco() + "</span><br>");
						out.write("</div>");
						out.write("</div>");
						out.write("</div>");
						out.write("</li>");
            ...
            <div id="carousel-example-generic-v5" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner">
                    <div class="item active">
                        <p>Palestra com o quadrinhista Luciano Salles no Instituto dos Quadrinhos <a href="http://bit.ly/1c0UN3Y">http://bit.ly/1c0UN3Y</a><p>
                        <p><a href="https://twitter.com/htmlstream">#hqsvenom</a></p>
                    ...
                    <div class="item">
                        <p>Star Wars publicará 20 livros até o lançamento de O Despertar da Força!</p>
                        <p><a href="https://twitter.com/htmlstream">#omeletetv</a></p>
                        <ul class="list-inline twitter-icons">
                            <li><a href="#"><i class="fa fa-reply"></i></a></li>
                            <li><a href="#"><i class="fa fa-retweet"></i></a></li>
                            <li><a href="#"><i class="fa fa-star"></i></a></li>
                    ...
                    <div class="item">
                        <p>ConheÃ§a a maior loja de Stickers para personalização de Notebooks e etc.. <a href="#">http://bit.ly/1d0HS3Y</a></p>
                        <p><a href="https://twitter.com/htmlstream">#nerdstickers</a></p>
                        <ul class="list-inline twitter-icons">
                            <li><a href="#"><i class="fa fa-reply"></i></a></li>
                            <li><a href="#"><i class="fa fa-retweet"></i></a></li>
                            <li><a href="#"><i class="fa fa-star"></i></a></li>
        ...
        <div class="row margin-bottom-60">
            <div class="col-md-4 product-service md-margin-bottom-30">
                ...
                <div class="product-service-in">
                    ...
                    <p>Efetuamos entregas rápidas e seguras em até 1 dia útil após a confirmação do Pagamento </p>
            ...
            <div class="col-md-4 product-service md-margin-bottom-30">
                ...
                <div class="product-service-in">
                    <h3>Atendimento</h3>
                    <p>Entre em contato conosco atréves de nossos telefone, Facebook, Twitter ou E-mail</p>
            ...
            <div class="col-md-4 product-service">
                ...
                <div class="product-service-in">
                    <h3>Devoluções</h3>
                    <p>Caso não goste de seu produto, você conseguirá devolve-lo em até 4 dias.</p>
    ...
    <div class="collection-banner">
        <div class="container">
            <div class="col-md-7 md-margin-bottom-50">
                <h2>NERD BOX</h2>
                <p>Com um pagamento mensal, receba em sua casa uma caixa surpresa <br>
				com produtos exclusivos da Adventure Books e Nerd Box.</p><br>
                <a href="#" class="btn-u btn-brd btn-brd-hover btn-u-light">Peça agora</a>
            </div>
            <div class="col-md-5">
    ...
    <div class="container content">
        <div class="heading heading-v1 margin-bottom-40">
            <h2>Colaboradores</h2>
            <p>Algumas lojas parceiras da Adventure Books, para você aumentar ainda mais sua coleção!</p>
        </div>
